        ...
        <div className="container">
          ...
          <div className="jumbotron">
            ...
            <p className="lead">
              ...
              <a href="https://facebook.github.io/react/docs/hello-world.html">ReactJS</a> aand later move on to refactor our app to use
              <a href="https://facebook.github.io/immutable-js/">Immutable</a> and <a href="http://redux.js.org/">Redux</a>.
            </p>
            <p>You can find all the relevant info in Git repo which also contains theassignment.</p>
            <p>
